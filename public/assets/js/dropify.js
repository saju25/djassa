        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                tpl: {
                    ...
                    preview: '<div style="display: none;" class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
