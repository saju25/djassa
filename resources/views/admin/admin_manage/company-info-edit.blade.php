                        ...
                        <div class="container mb-3">
                            <div class="recent_activities card p-3">
                                <h3 class="d-flex align-content-center "><i class="fa-regular fa-file bc mx-2"></i>Edit
                                  ...
                                  <form action="{{ route('admin.comIn.update', $comIns->id) }}" method="post"
                                    ...
                                    <div class="m-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Company Name" value="{{$comIns->name}}">
                                            @error('name')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="phone" class="form-control"
                                                placeholder="Company Phone Number" value="{{$comIns->phone}}">
                                    ...
                                    <div class="m-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="email" name="email" class="form-control"
                                                placeholder="Company E-mail" value="{{$comIns->email}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="location" class="form-control"
                                                placeholder="Company Location" value="{{$comIns->location}}">
