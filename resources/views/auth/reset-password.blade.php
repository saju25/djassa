<x-guest-layout>
    ...
    <!-- Session Status -->
    <x-auth-session-status class="mb-5 section-header" :status="session('status')" />

    <div class="container ">
        <div class="row justify-content-center rest_page">
            <div class="col-md-6 recent_activities p-3 shadow-lg>
                ...
                <div class="mb-3 row">
                    <div>
                        ...
                        <div class="">
                            <x-text-input id="email" class="form-control" placeholder="Entrer votre Email..."
                    ...
                    <!-- Confirm Password -->
                    <div class="mt-4">
                        <x-input-label class="col-form-label" for="password_confirmation"
