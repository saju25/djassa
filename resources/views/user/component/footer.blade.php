                ...
                <div class="row">
                            ...
                            <div>
                                ...
                                <div class="p-2">
                                    <div id="ele_btn2" class="category-btn" data-input-id="ele_ch2">
                                        ...
                                        <input id="ele_ch2" type="checkbox" name="add_category" value="Électronique"
                                            hidden>
                                    </div>
                                </div>
                                ...
                                <div class="p-2">
                                    <div id="me_btn2" class="category-btn" data-input-id="me_ch2">
                                        <div>Véhicules</div>
                                        <input id="me_ch2" type="checkbox" name="add_category" value="Véhicules" hidden>
                                    </div>
                                </div>
                                ...
                                <div class="p-2">
                                    <div id="wo_btn" class="category-btn" data-input-id="wo_ch2">
                                        <div>Maison & Vie</div>
                                        <input id="wo_ch2" type="checkbox" name="add_category" value="Maison & Vie"
                                            hidden>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-3 col-lg-3 contact-box">
                        ...
                        <ul class="addressFooter">
                            ...
                            @endphp
                            <li><i class="icon anm anm-map-marker-al px-2"></i>
                                <p>{{ $webSocialLinks->address }}</p>
                            </li>
                            <li class="phone"><i class="icon anm anm-phone-s px-2"></i>
                                <p>{{ $webSocialLinks->number }}</p>
                            </li>
                            <li class="email"><i class="icon anm anm-envelope-l px-2"></i>
