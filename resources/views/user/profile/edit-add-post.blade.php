<x-app-layout>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" name="name" class="form-control" placeholder="Nom" value="{{ old('name', $product->name) }}">
            @error('name')
        ...
        <div class="col-md-6">
            ...
            <input type="number" name="sku" class="form-control" placeholder="Quantité" value="{{ old('sku', $product->sku) }}">
            @error('sku')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <textarea id="editor" class="col-form-label w-100 p-3" name="description" placeholder="Description du produit">{{ old('description', $product->description) }}</textarea>
            @error('description')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="number" name="best_price" class="form-control" placeholder="Prix" value="{{ old('best_price', $product->best_price) }}">
            @error('best_price')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-6">
            <div>
                <label class="col-form-label">Dernier prix</label>
            </div>
            <input type="number" name="discounted_price" class="form-control" placeholder="Dernier prix" value="{{ old('discounted_price', $product->discounted_price) }}">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <select class="form-select w-100" name="Ville">
